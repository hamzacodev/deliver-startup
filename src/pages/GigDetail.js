        ...
        >
          <DialogContent>
            <div className="flex flex-col items-center">
              <img src={OK} />
              <h2 className="font-primary">Success</h2>
              <p className="text-center">
                Your booking has been confirmed successfully. Please review it
                or go back to the listing page
              </p>
              <div>
                <button className="border border-primary btn w-[10rem] mr-3 rounded-[10px] text-primary font-medium mt-3 h-[50px] ">
                  Chat
                </button>
                <Link to="/give-rating">
                  <button
                    onClick={handleClose}
                    className="bg-primary btn w-[10rem] rounded-[10px] text-light font-medium mt-3 h-[50px]"
                  >
                    Go Back
                  </button>
                </Link>
      ...
      <div className="container">
        <div className=" rounded-[30px] py-[2rem] relative">
          ...
          <div className="text-center mx-[4%] mb-[2%]">
            <h1 className="text-dark primary-font my-auto">Gig Completed</h1>
          </div>
              ...
              return (
                <>
                  <div className="card sm:w-[780px] w-[320px] rounded-[30px] p-[20px] m-3 p-[30px]">
                    <div className="between">
                      ...
                      <div className="flex my-auto">
                        ...
                        <button
                          ...
                          className="bg-primary btn w-[8rem]  rounded-[10px] text-light font-medium mt-3 h-[50px]"
                        >
                          Book Now
                        </button>
                      </div>
                    ...
                    <div className="flex">
                      <h4 className="fw-bold  mr-[30px] text-muted">
                        18 Feb 2023
                      </h4>
                      <div className="border-l-[1.5px] border-gray-500 h-[30px] my-auto"></div>
                      <h4 className="fw-bold pl-[20px] h-[30px] text-muted">
                        Sara Ahmed
                      </h4>
                    </div>
                  </div>
